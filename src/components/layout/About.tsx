  ...
  return (
    <div className="relative py-24 px-6 bg-gradient-to-r from-amber-200 to-slate-50 text-gray-300">
      ...
      <div className="absolute top-4 right-4">
        <Link to="/">
          <button className="bg-blue-700 text-black font-semibold py-3 px-4 rounded-md">
            Return home
          </button>
        </Link>
      </div>

      <div className="max-w-3xl mx-96 py-4">
  <h2 className="text-4xl md:text-4xl font-bold text-black mb-4 text-center">
    Plateau Scholarship Program
  </h2>
  <p className="text-lg text-black font-mono leading-relaxed text-justify">
